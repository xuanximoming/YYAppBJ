 ...
 */
package com.yy.key.QRcodeScan.activity;
...
import com.yy.app.R;
import com.yy.key.QRcodeScan.assit.AmbientLightManager;
import com.yy.key.QRcodeScan.assit.BeepManager;
import com.yy.key.QRcodeScan.camera.CameraManager;
import com.yy.key.QRcodeScan.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void handleDecode(Result rawResult) {
        ...
        mIntent.putExtra("change01", rawResult.getText().toString().trim());
