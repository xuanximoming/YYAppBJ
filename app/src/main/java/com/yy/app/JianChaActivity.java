...
public class JianChaActivity extends Activity implements OnClickListener {
	...
	private void init() {
		...
		activity_title_name.setText("检查");
				...
				case 101:
					...
					if (data == null) {
						if (Statics.internetcode != -1) {
							MyUntils.myToast(JianChaActivity.this,
									Statics.internetstate[Statics.internetcode]);
						}else{
							MyUntils.myToast(JianChaActivity.this,"此病人暂无检查信息");
						}
					} else if (data.size() > 0) {
						System.out.println(data.toString());
						adapter = new JianChaAdapter(data, JianChaActivity.this);
						listview.setAdapter(adapter);
					} else {
//						MyUntils.myToast(JianChaActivity.this, "获取信息失败");
						MyUntils.myToast(JianChaActivity.this,"此病人暂无检查信息");
					}
					break;
