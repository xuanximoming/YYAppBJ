...
// * 版本检测，自动更新
// *
// * @author 1.通过Url检测更新 2.下载并安装更新 3.删除临时路径
// *
// */
...
//	// 服务器地址
//	private String strURL = "http://"+ Statics.IP + ":" + Statics.Port + Statics.ApkURL+Statics.ApkVersion+".apk";
...
//			showUpdateDialog();
//		} else {
//			MyUntils.myToast(this.activity, "当前已是最新版本");
//		}
//	}
//
//	/**
...
//				.setTitle("发现有升级新版本").setIcon(R.drawable.docter)
//				.setMessage("是否升级更新？")
...
//			File myTempFile = new FileUntil(activity).createSDFile(fileNa + "."
//					+ fileEx);
//			// 安装包文件临时路径
